...
const sampleData = {
    ...
    users: [
        ...
        },
        {
            ...
            fullName: 'Nguyen Thi Bibliothécaire',
            role: 'LIBRARIAN',
            status: 'ACTIVE',
        },
        {
            ...
            const sampleLoans = [
                {
                    ...
                    status: 'BORROWED',
                    notes: 'Livre pour le cours de programmation Java',
                },
                {
                ...
                },
                {
                    ...
                    status: 'RETURNED',
                    notes: 'Livre de développement web retourné',
                },
            ];
